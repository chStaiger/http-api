...
class TestSomething(RestTestsAuthenticatedBase):
    ...
    _main_endpoint = '/statics/metadata'
    # qui l'endpoint dichiarati in specs.yaml /statics/metadata
    _my_params = '?start="12-02-2017T00.00.00"&end="13-02-2017T00.00.00' + \
        '"&minlat=12.30&minlon=12.30&maxlat=12.30&maxlon=12.30&download=False'
